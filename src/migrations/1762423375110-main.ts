...
export class Main1762423375110 implements MigrationInterface {
    name = 'Main1762423375110'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pricing" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "turf_id" uuid NOT NULL, "day_type" "public"."pricing_day_type_enum" NOT NULL, "time_slot" "public"."pricing_time_slot_enum" NOT NULL, "price" numeric(10,2) NOT NULL, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_15d1e0664e1895b31bff3919fe8" UNIQUE ("turf_id", "day_type", "time_slot"), CONSTRAINT "PK_4f6e9c88033106a989aa7ce9dee" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "bookings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "turf_id" uuid NOT NULL, "user_id" uuid NOT NULL, "date" date NOT NULL, "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP NOT NULL, "price" numeric(10,2) NOT NULL, "status" "public"."bookings_status_enum" NOT NULL DEFAULT 'pending', "created_by" text, "cancelled_at" TIMESTAMP, "cancellation_reason" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bee6805982cc1e248e94ce94957" PRIMARY KEY ("id"))`);
